    ...
    >
      ...
      >
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img
            src="../public/aquariumlogo.jpeg"
            class="h-10"
            alt="AquriumDevs Logo"
          />
          <span
        ...
        >
          ...
          >
            <li>
              <a
                href="#"
                class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-200 md:p-0 hover:text-gray-300"
                aria-current="page"
                >Inicio</a
              >
            </li>
